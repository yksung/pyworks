...
class Query():
    ...
    def get_project_seq_query(self):
        projectSeqArr = [ x for x in self.params['project_seqs'].split(",") ]
        
        return {
            "terms" : {
                "project_seq" : projectSeqArr
            }
        }
    ...
    def get_total_dataset_query(self, project_seqs):
        dataset_keyword_list = mariadb.get_keywords_per_project(project_seqs) # dataset 시퀀스로 dataset_keyword 조회
...
if __name__ == '__main__':
    ...
    print(queryObj.get_total_dataset_query("186,185,184,183,182,181,180,179,178,177,176"))